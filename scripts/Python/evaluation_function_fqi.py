...
if __name__ == '__main__':
    evaluate(25, 64, 5000, 1, '../../datasets/transactions/historical_transactions_2019-07-03.csv', '../../datasets/PV/total_power_consumption_2019-07-03.csv', '../../datasets/trajectories/', '../../models/', False)